...
describe('VerifierService', () => {
  ...
  beforeEach(async () => {
    ...
    commonConfigService = {
      config: {
        urls: {
          api: 'https://devnet-api.dharitri.org',
        },
        pinata: {
  ...
  it('should throw error when contract is not found - getContractVerifier', async () => {
    ...
    await expect(service.getContractVerifier(mockAddress)).rejects.toThrow(
      new NotFoundException(
        'Verified contract not found for address: drt1qqqqqqqqqqqqqpgqvxzjqasv3jsu5kxtk8ergnqdhuk3vfmnd8ssvt4mj7',
      ),
    );
  });
  ...
  it('should get contract verifier info', async () => {
    ...
    expect(result).toEqual({
      ...
      dockerImage: 'terradharitri/sdk-rust-contract-builder:v10.0.0',
  ...
  it('should throw could not determine owner address - delete contract verifier', async () => {
    ...
    const requestBody = {
      ...
      payload: {
        contract: 'drt1qqqqqqqqqqqqqpgqvxzjqasv3jsu5kxtk8ergnqdhuk3vfmnd8ssvt4mj7',
  ...
  it('should throw could not determine owner address for owner contract - delete contract verifier', async () => {
    apiService.get.mockResolvedValueOnce({
      data: {
        ownerAddress: 'drt1qqqqqqqqqqqqqpgqxvqq8mdy20eq6u9t09sp2tqt0f6gpyr0d8ssj6l2ru',
      },
    });
  ...
  it('should throw owner of owner contract is smart contract - delete contract verifier', async () => {
    ...
    apiService.get.mockResolvedValueOnce({
      data: {
        ownerAddress: 'drt1qqqqqqqqqqqqqpgqnsfdqlxg7c2nhf3hpqx53qj8uu5jre6dd8ss54v0mn',
      },
    });
  ...
  it('should return invalid signature - delete contract verifier', async () => {
    apiService.get.mockResolvedValue({
      data: {
        ownerAddress: 'drt1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssey5egf',
      },
    });
  ...
  it('should throw error for not verified contract - delete contract verifier', async () => {
    ...
    const requestBody = {
      ...
      payload: {
        contract: 'drt1qqqqqqqqqqqqqpgq8uzcu905yt6xk7k6eg9gnhhxp6gk9swnd8ssur2v0t',
        codeHash: '7f7376f37a9f809a1a9b21b60a2a9afe7c9d22ab65807324f537ab3696110a58',
      },
    };
    ...
    await expect(service.removeContractVerifierSource(requestBody)).rejects.toThrow(
      new NotFoundException(
        'Verified contract not found for address: drt1qqqqqqqqqqqqqpgq8uzcu905yt6xk7k6eg9gnhhxp6gk9swnd8ssur2v0t',
      ),
    );
  ...
  it('should throw error if owner is SC and owner of owner is SC - delete contract verifier', async () => {
    ...
    apiService.get.mockResolvedValueOnce({
      data: {
        ownerAddress: 'drt1qqqqqqqqqqqqqpgq9ph6uhdl2hkq7sarxxwycr6txnx0ewcal3tsjy8axs',
      },
    });
    apiService.get.mockResolvedValueOnce({
      data: {
        ownerAddress: 'drt1qqqqqqqqqqqqqpgqq75vtleur5rg74nk4f88ql6a7ajas073l3ts9gg3mm',
      },
    });
